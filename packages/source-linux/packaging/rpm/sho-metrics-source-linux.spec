...
%changelog
* Sun Sep 13 2026 Emanuele Sparvoli <sparvoli@gmail.com> - 0.3.0^linux1-1
- First COPR build of the Linux helper daemon (fork tag v0.3.0-linux.1)
