#!/usr/bin/env node
// Sho Metrics Linux helper: serves Linux hardware sensors to the Sho Metrics
// plugin over its MetricSourceService gRPC contract (contracts/proto).
// Linux counterpart of packages/source-windows, owned by this fork.
//
// Sources:
...
// Tracks the fork release this daemon ships with (upstream base + linux rev).
